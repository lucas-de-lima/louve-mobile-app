...
### Fase 4a — Bug Fixes (escrita controlada)
1. Agente implementa correções em branches `fix/`
2. Mudanças pequenas e isoladas (máximo 3 arquivos)
3. Agente escreve testes para a correção
