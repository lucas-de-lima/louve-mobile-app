# 4. Guia de UI e Theming — ANTIGA

> ⚠️ **Este documento está desatualizado e foi substituído por [`4. Guia de UI e Theming - NOVA.md`](4.%20Guia%20de%20UI%20e%20Theming%20-%20NOVA.md).** Mantido apenas para contexto histórico. Consulte a versão NOVA para a documentação vigente do sistema de temas. Detalhes técnicos adicionais também em [`THEMING_DOCS.md`](THEMING_DOCS.md).
