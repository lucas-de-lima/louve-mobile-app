...
- **Contas e Favoritos:** A personalização transcende o visual. O usuário pode guardar os seus hinos mais queridos, aqueles que marcaram momentos da sua vida, e levar as suas preferências consigo para qualquer dispositivo, tornando a experiência verdadeiramente sua e persistente. (Implementado: login Google + favoritos híbridos local/remoto.)
